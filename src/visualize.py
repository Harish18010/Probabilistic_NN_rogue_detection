...
def generate_plots():
    ...
    rogue_dataset = LoRaDataset(r'data\raw\Test\dataset_rogue.h5', subset_size=50)
    ...
    plt.axvline(x=0.1, color='black', linestyle='dashed', linewidth=2, label='Security Threshold (0.1)')
